...
mmnl_model <- function(processed_path = NULL, output_dir = "output"){
  ...
  ### ========================================================
  ### STEP 3 – Build choice variables and check consistency
  ### ========================================================
  ...
  ### ========================================================
  ### STEP 4 – Define starting values and fixed parameters
  ### ========================================================
  ...
  ### ========================================================
  ### STEP 5 – Specify draws and random coefficients
  ### ========================================================
  ...
  ### ========================================================
  ### STEP 6 – Define utilities and validate model inputs
  ### ========================================================
  ...
  summary_path <- file.path(
    ...
    paste0(apollo_control$modelName, "_modelOutput.txt")
  )
...
# Auto-run once when sourced directly; orchestrators can skip via option
